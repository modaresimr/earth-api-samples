if (!window.lineStringPlacemark) {
  ...
  if (!window.lineStringPlacemark.getStyleSelector()) {
    window.lineStringPlacemark.setStyleSelector(ge.createStyle(''));
  }
  ...
  var lineStyle = window.lineStringPlacemark.getStyleSelector().getLineStyle();
